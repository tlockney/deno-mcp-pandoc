...
function createMCPServer(): Server {
      ...
      tools: [
        {
          ...
          description:
            "Convert document contents between formats using Pandoc. " +
          ...
          inputSchema: {
            ...
            properties: {
              ...
              output_file: {
                type: "string",
                description:
                  "Path to output file (required for PDF, DOCX, EPUB, ODT)",
              },
              reference_doc: {
                type: "string",
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    if (args.contents) {
      ...
      throw new Error("Invalid arguments: must provide contents or both input_file and output_file");
    }
  });
